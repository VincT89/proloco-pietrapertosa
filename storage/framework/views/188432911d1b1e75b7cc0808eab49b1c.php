    ...
    <div class="nav-right">
        <div class="links" id="links">
            ...
            <div class="lang-switcher">
                <a href="<?php echo e(url('/it' . substr(request()->getRequestUri(), 3))); ?>" class="lang-link <?php echo e(!(app()->getLocale() === 'en') ? 'active' : ''); ?>">IT</a>
                <span class="lang-sep">|</span>
                <a href="<?php echo e(url('/en' . substr(request()->getRequestUri(), 3))); ?>" class="lang-link <?php echo e((app()->getLocale() === 'en') ? 'active' : ''); ?>">EN</a>
            </div>
        </div>
