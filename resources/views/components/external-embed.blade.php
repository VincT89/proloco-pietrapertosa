...
<div class="external-embed external-embed-ratio-{{ $ratio }}" data-external-embed="true" data-src="{{ $src }}" data-provider="{{ $provider }}" data-title="{{ $title }}">
    <div class="external-embed-placeholder">
        <div class="external-embed-text">
            ...
            <button type="button" class="ed-btn ed-btn-small external-embed-button">{{ __('legal.enable_external') }}</button>
        </div>
    </div>
</div>
