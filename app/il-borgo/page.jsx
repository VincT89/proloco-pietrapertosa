...
export default function IlBorgo() {
  return (
    <StoreProvider>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
          {borgoData.stats.map((s, i) => (
            <div key={i} className="fad parchment-badge" style={{ 
              ...
              <div style={{ fontSize: '2.4rem', color: '#1a1a1a', fontFamily: "'Newsreader', serif", marginBottom: '8px', lineHeight: '1', fontWeight: '500' }}>{s.value}</div>
      ...
      <PageCTA subtitle="Un viaggio nel tempo" title="Pronto a esplorare?" text="Scopri le nostre esperienze e prenota la tua avventura." btnText="Vedi Esperienze" btnLink="/esperienze" icon={Map} />
